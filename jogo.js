...
$(document).ready( function(){
	...
	$('#btn_iniciar_jogo').click( function(){
		...
		alert($('#entrada_apelido1').val());
		alert($('#entrada_apelido2').val());
	...
	$('#botao_voltar').click( function(){
		...
		$('#palco_jogo').hide();
		$('#pagina_inicial').show();
		$('input[name=nome_1').val('');
		$('input[name=nome_2').val('');
        location.reload(true);

	});
	//reiniciar
	//$('#botao_reiniciar').click( function(){
	...
	function ganhador(pontos){
		if(pontos == -3){
			...
			alert(jogada_1 + ' é o(a) vencedor(a). Parabéns!!');
			$('.jogada').off();
		
		} else if(pontos == 3){
			var jogada_2 = $('#entrada_apelido2').val();
			alert(jogada_2 + ' é o(a) vencedor(a). Parabéns!!');
			$('.jogada').off();
		}
